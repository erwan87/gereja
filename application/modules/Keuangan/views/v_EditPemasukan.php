                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            ...
                            <?= form_open_multipart('Keuangan/actionEditPemasukan/'.$pemasukan[0]['id_pemasukan']);?>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="mainAkun">Main Akun</label>
                                    <select class="form-control" id="mainAkun" name="mainAkun">
                                        <option value="1 "
                                            <?php $pemasukan[0]['id_main_akun']===1 ? $selected='SELECTED' : $selected = ''; echo $selected; ;?>>
                                            Penerimaan</option>
                                    </select>
                                </div>
                                ...
                                <div id="akun" class="form-group">
                                    ...
                                    foreach ($akun as $data) {
                                        if($data['id_akun']===$pemasukan[0]['id_akun']){
                                            $selected = 'SELECTED';
                                        }else{
                                            $selected = '';
                                        }
                                ...
                                <div id="subakun" class="form-group">
                                    ...
                                    foreach ($subakun as $data) {
                                        if($data['id_sub_akun']===$pemasukan[0]['id_sub_akun']){
                                            $selected = 'SELECTED';
                                        }else{
                                            $selected = '';
                                        }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control tgl_pemasukan" id="tgl_pemasukan"
                                        name="tgl_pemasukan" value="<?= tgl_indo($pemasukan[0]['tanggal']);?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nominal" name="nominal"
                                        ...
                                        value="<?= $pemasukan[0]['nominal'];?>" required>
                                </div>
                            </div>
