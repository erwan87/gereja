...
class Depan_model extends CI_Model
{
    ...
    // Global View All Limit
    public function viewAllLimit($select, $tbl, $order, $sort, $limit)
    {
        $this->db->select($select);
        $this->db->from($tbl);
    ...
    // Global View Global Join Limit
    public function viewGlobalJoinLimit($select, $tbl, $join, $limit)
    {
        $this->db->select($select);
        $this->db->from($tbl);
        $this->db->limit($limit);
