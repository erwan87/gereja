                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            ...
                            <?= form_open_multipart('Warta/actionAddWarta');?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="dukungan" id="dukungan"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="thanks" id="thanks"></textarea>
                                    </div>
                                </div>
